...
$channelAccessToken = 'gXj/EI29bckDHEhF0elteszsSTU15XOF0mpDzOoMMO121eotir5KIDFkv0fGCuNtez/e1YfMzbhhVLblVr8LiKsHO8ktxf7xDwGjk6ZOszGNFX3zWePPqRxf3JmtLmJ1/CftQ/HFEmz1FXwtTUDa4wdB04t89/1O/w1cDnyilFU='; // Access Token ค่าที่เราสร้างขึ้น
	...
	if ($event['type'] == 'message') 
	{
		if($event['message']['type'] == 'text')
		{
			...
			if($text == "@บอท" || $texts[0] == "@บอท"){
				...
				$reply_message .= "พิมพ์ว่า  0 \"การขายสุรา ยาสูบ ไพ่\"\n";
				$reply_message .= "พิมพ์ว่า  1 \"พิกัดอัตราภาษีสรรพสามิต\"\n";
				$reply_message .= "พิมพ์ว่า  2 \"อัตราภาษีสรรพสามิตรถยนต์\"\n";
				$reply_message .= "พิมพ์ว่า  3 \"ขั้นตอนการขอใบอนุญาตขายสุรา\"\n";
				$reply_message .= "พิมพ์ว่า  4 \"กำหนดประเภทสินค้าตามพิกัดอัตราภาษีสรรพสามิต (ฉบับที่ 2) พ.ศ. 2564\"\n";
